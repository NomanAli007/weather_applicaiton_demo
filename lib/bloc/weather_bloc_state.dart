...
class WeatherSearchLoading extends WeatherBlocState {}

class WeatherSearchFailure extends WeatherBlocState {}

class WeatherSearchSuccess extends WeatherBlocState {
  final Weather weather;

  const WeatherSearchSuccess(this.weather);
